...
def test_navbar_navigation_works(page: Page):
    ...
    expect(page).to_have_url("http://localhost:8080/blog/1")
...
def test_routing_system_works(page: Page):
